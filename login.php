				...
				<div class="col-md-6">
					<div class="box-content">
						...
						<?php if(isset($_GET['message'])){ 
							...
							?>
						<form form class="logregform" method="post" action="registerprocess.php">
							<div class="row">
								<div class="form-group">
									<div class="col-md-12<?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
										<label>E-mail Address</label>
										<input type="email" name="username" required value="" class="form-control">
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-6 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
										...
										<input type="password" name="confirm_password" required value="" class="form-control">
