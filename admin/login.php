...
<div id="wrapper" class="wrapper">
	<!-- HEADER -->
	<header id="header2" style="background-color:#3a4468;">
		<div class="container">
			<div class="row">
			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<h2>Login</h2>
						<p>Admin Login</p>
                                      <br/><strong><u><a href="http://localhost/minics/" style="color:blue">GO to Home </a></u></strong>
					</div>
					<div class="col-md-12">
	...
	<!-- FOOTER -->
	<footer id="footer2" style="background-color:#3a4468;">
