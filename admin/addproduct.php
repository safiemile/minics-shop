			...
			if(isset($name) && !empty($name)){
				if(($extension == "jpg" || $extension == "jpeg") && $type == "image/jpeg" && $size<=$max_size){
					...
					if(move_uploaded_file($tmp_name, $location.$name)){
						...
						$sql = "INSERT INTO products (name, description, catid, price, qty, thumb) VALUES ('$prodname', '$description', '$category', '$price', '$quantity', '$location$name')";
		...
		<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
			<form method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="productquantity" id="productprice" placeholder="Product Quantity">
			  </div>
			  <div class="form-group">
