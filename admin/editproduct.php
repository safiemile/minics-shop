<?php
	...
	if(isset($_POST) & !empty($_POST)){
		...
		$sql = "UPDATE products SET name='$prodname', description='$description', catid='$category', price='$price', qty='$quantity', thumb='$filepath' WHERE id = $id";
			...
			<form method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="productquantity" id="productprice" placeholder="Product Quantity" value="<?php echo $r['qty']; ?>">
			  </div>
			  <div class="form-group">
