	...
	<section id="content">
		<div class="content-blog">
					<div class="page_header text-center">
						<h2>Shop - Profile</h2>
						<p>Get the best  smooth Services at Minics </p>
					</div>
<form method="post">
<div class="container">
			<div class="row">
					...
					<div class="billing-details">
						...
						<div class="space30"></div>
							...
							<select name="country" class="form-control" required>
								...
								<option value="DR">Deomctaric Republic of Congo</option>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input name="fname" required class="form-control" placeholder="" value="<?php if(!empty($r['firstname'])){ echo $r['firstname']; } elseif(isset($fname)){ echo $fname; } ?>" type="text">
								</div>
								<div class="col-md-6">
									<label>Last Name </label>
									<input name="lname" required class="form-control" placeholder="" value="<?php if(!empty($r['lastname'])){ echo $r['lastname']; }elseif(isset($lname)){ echo $lname; } ?>" type="text">
								</div>
							</div>
							<div class="clearfix space20"></div>
							...
							<div class="clearfix space20"></div>
							<label>Phone </label>
							<input name="phone"  required class="form-control" id="billing_phone" placeholder="" value="<?php if(!empty($r['mobile'])){ echo $r['mobile']; }elseif(isset($phone)){ echo $phone; } ?>" type="text">
						<div class="space30"></div>
