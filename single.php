...
if(isset($_POST) & !empty($_POST)){
 ...
 $review = filter_var($_POST['review'], FILTER_SANITIZE_STRING);
	...
	echo'<script>alert("Please login first to Add Review");</script>';
		 $smsg= " Dear Customer Login First";
	 }
			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<h2>Shop</h2>
						<p>Get the best services from Minics Shop</p>
					</div>
			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<p>Available Stock: <?php echo $prodr['qty']; ?> Pcs</p>
									...
									if($uid!= 0){
										...
										<div class="row">
											<div class="col-md-6 space20">
												<input name="name" class="input-md form-control" placeholder="Name *" maxlength="100" required="" type="text" value="<?php if($uid!= 0){ echo $userr['firstname'] . " " . $userr['lastname'];} else{ echo" You Are Not Logedin! "; }?>" disabled>
											</div>
											<div class="col-md-6 space20">
												<input name="email" class="input-md form-control" placeholder="" maxlength="100" required="" type="email" value="<?php if($uid!= 0) { echo $userr['email']; }?>" disabled>
											</div>
										</div>
